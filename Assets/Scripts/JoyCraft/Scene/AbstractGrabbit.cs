...
namespace JoyCraft.Scene {
    public abstract class AbstractGrabbit : MonoBehaviour, IOutline {
        ...
        public virtual AbstractGrabbit Grab (Vector3 mousePoint) {
            grabbed = true;
        ...
        public virtual AbstractGrabbit Release () {
